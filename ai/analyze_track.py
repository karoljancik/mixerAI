...
from beat_sync import estimate_beat_offset_seconds
...
def analyze_track(file_path: str, output_json: str) -> None:
    ...
    beat_offset = estimate_beat_offset_seconds(beat_times, onset_envelope, sr, hop_length, duration, tempo_float)
